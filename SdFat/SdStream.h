 ...
 */
class SdStreamBase : public SdBaseFile, virtual public ios {
 protected:
  /// @cond SHOW_PROTECTED
  int16_t getch();
  void putch(char c);
 ...
 */
class fstream : public iostream, public SdStreamBase {
 public:
  using iostream::peek;
  fstream() {}
 ...
 */
class ifstream : public istream, public SdStreamBase {
 public:
  using istream::peek;
  ifstream() {}
  /** Constructor with open
 ...
 */
class ofstream : public ostream, public SdStreamBase {
 public:
  ofstream() {}
  /** Constructor with open
   * \param[in] path file to open
